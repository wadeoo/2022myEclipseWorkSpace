<%@ page import="com.sm.gotravel.bean.Search" %>
<%@ page import="com.sm.gotravel.bean.Booking" %>
<%
...
<div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="/goTravel/index.jsp" class="w3-bar-item w3-button w3-wide"><img src="img/favicon.png" class="img-fluid" alt="image" width="18%">  FlyAway</a>
    <div class="w3-right w3-hide-small">
        <a href="/goTravel/login.jsp" class="w3-bar-item w3-button"><i class="fa fa-gear"></i> Admin Login</a>
    </div>
</div>
    <div class="container">
