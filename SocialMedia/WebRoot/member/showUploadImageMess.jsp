...
%>    
    <%@ page import="com.sm.lzd.model.member.Login"%>
    <%@ page import="com.sm.lzd.model.member.UploadFile"%>      
<jsp:useBean id="login" type="com.sm.lzd.model.member.Login" scope="session"/>
<jsp:useBean id="userImage" type="com.sm.lzd.model.member.UploadFile" scope="request"/>
